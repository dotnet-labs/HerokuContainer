...
public class ColorsController(ILogger<ColorsController> logger) : ControllerBase
{
    /// <summary>
    ...
    public ActionResult<ColorContrastRatio> GetContrastRatio(string fc, string bc)
    {
        ...
        logger.LogInformation("Checking the Contrast Ratio between Foreground Color [{fc}] and Background Color [{bc}].", fc, bc);
    ...
    public ActionResult<ColorBrightnessDifference> GetBrightnessDifference(string fc, string bc)
    {
        ...
        logger.LogInformation("Checking the ColorBrightnessDifference between Foreground Color [{fc}] and Background Color [{bc}].", fc, bc);
        var fColor = ColorTranslator.FromHtml("#" + fc);
        var bColor = ColorTranslator.FromHtml("#" + bc);
    ...
    public ActionResult<ColorDifference> GetColorDifference(string fc, string bc)
    {
        ...
        logger.LogInformation("Checking the ColorDifference between Foreground Color [{fc}] and Background Color [{bc}].", fc, bc);
        var fColor = ColorTranslator.FromHtml("#" + fc);
        var bColor = ColorTranslator.FromHtml("#" + bc);
